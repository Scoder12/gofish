...
pub mod error {
  ...
  mod _private {
    pub const TYPE_ID: u64 = 0xa5a6_4dcd_85f6_8b6e;
  }
}
...
pub mod game_created {
  ...
  mod _private {
    pub const TYPE_ID: u64 = 0xc0ef_d633_78b1_868d;
  }
}

pub mod msg {
  pub use self::Which::{Error,GameCreated};
  ...
  impl <'a,> Reader<'a,>  {
    ...
    #[inline]
    pub fn has_game_created(&self) -> bool {
    ...
    pub fn which(self) -> ::core::result::Result<WhichReader<'a,>, ::capnp::NotInSchema> {
      match self.reader.get_data_field::<u16>(0) {
        ...
        1 => {
          ::core::result::Result::Ok(GameCreated(
            ::capnp::traits::FromPointerReader::get_from_pointer(&self.reader.get_pointer_field(0), ::core::option::Option::None)
          ))
        }
  ...
  impl <'a,> Builder<'a,>  {
    ...
    #[inline]
    pub fn set_error(&mut self, value: crate::s2c_capnp::error::Reader<'_>) -> ::capnp::Result<()> {
      self.builder.set_data_field::<u16>(0, 0);
      ::capnp::traits::SetPointerBuilder::set_pointer_builder(self.builder.reborrow().get_pointer_field(0), value, false)
    }
    #[inline]
    pub fn init_error(self, ) -> crate::s2c_capnp::error::Builder<'a> {
      self.builder.set_data_field::<u16>(0, 0);
    ...
    #[inline]
    pub fn set_game_created(&mut self, value: crate::s2c_capnp::game_created::Reader<'_>) -> ::capnp::Result<()> {
      self.builder.set_data_field::<u16>(0, 1);
      ::capnp::traits::SetPointerBuilder::set_pointer_builder(self.builder.reborrow().get_pointer_field(0), value, false)
    }
    #[inline]
    pub fn init_game_created(self, ) -> crate::s2c_capnp::game_created::Builder<'a> {
      self.builder.set_data_field::<u16>(0, 1);
      ::capnp::traits::FromPointerBuilder::init_pointer(self.builder.get_pointer_field(0), 0)
    }
    #[inline]
  ...
  mod _private {
    pub const TYPE_ID: u64 = 0x9e33_ed27_8926_da05;
  }
  pub enum Which<A0,A1> {
    Error(A0),
    GameCreated(A1),
  }
  pub type WhichReader<'a,> = Which<::capnp::Result<crate::s2c_capnp::error::Reader<'a>>,::capnp::Result<crate::s2c_capnp::game_created::Reader<'a>>>;
  pub type WhichBuilder<'a,> = Which<::capnp::Result<crate::s2c_capnp::error::Builder<'a>>,::capnp::Result<crate::s2c_capnp::game_created::Builder<'a>>>;
}
